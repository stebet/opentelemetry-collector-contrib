...
The EMA Tail Sampling processor uses an Exponential Moving Average (EMA) algorithm to
dynamically adjust per-key sampling rates so that the fraction of kept traces approaches
a configurable goal sample rate.

## Configuration

| Field | Type | Default | Description |
|---|---|---|---|
| `goal_sample_rate` | int | 10 | Target 1-in-N sample rate. |
